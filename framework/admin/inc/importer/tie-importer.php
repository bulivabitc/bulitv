...
function tie_set_demo_data(){
	...
	$theme_options['banner_top_url'] 	= $theme_options['banner_bottom_url'] 	= 'https://tielabs.com/buy/sahifa-envato-1';
...
//HomePage
	...
	tie_addWidgetToSidebar( 'primary-widget-area', 'ads300_250-widget', 0, array( 'tran_bg' => true, 'new_window' => true, 'ads1_url' => 'https://tielabs.com/buy/sahifa-envato-1/', 'ads1_img' => 'http://themes.tielabs.com/data/banners/sahifa-300.jpg' ));
...
function tie_addWidgetToSidebar( $sidebarSlug = false, $widgetSlug = false, $countMod = false, $widgetSettings = array()){
	$sidebarOptions = get_option('sidebars_widgets' );

	if( empty( $sidebarOptions  ) ){
